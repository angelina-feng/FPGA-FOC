...
// Function：7-segment SVPWM generator (modulator)
...
// Note: The frequency of the PWM generated by this module is the clock frequency divided by 2048. 
// For example, if the clock frequency is 36.864 MHz, the PWM frequency is 36.864 MHz / 2048 = 18 kHz.
//--------------------------------------------------------------------------------------------------------

module svpwm (
    input  wire        rstn,
    input  wire        clk,
    input  wire [ 8:0] v_amp,                       // The magnitude of the maximum voltage vector in SVPWM
    input  wire [11:0] v_rho,                       // Magnitude of the voltage vector in the stator polar coordinate system, Vsρ
    input  wire [11:0] v_theta,                     // Angle of the voltage vector in the stator polar coordinate system (Vsθ)
    output reg         pwm_en, pwm_a, pwm_b, pwm_c  // PWM enable signal pwm_en; 3-phase PWM signals pwm_a, pwm_b, pwm_c
);
